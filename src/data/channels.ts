...
export const CHANNELS: Channel[] = [
  ...
  {id:'CH-2',name:'Claude Code Web',surface:'claude.ai/code',access:'GitHub connector + threads + memory',coverage:'Repo deep-read · Sprint S0/S1 closure · skill count · contracts',status:'queued',output:'reports/CH2-github-threads-{date}.md',conflicts:0},
  ...
  {id:'CH-4',name:'Perplexity + Comet',surface:'perplexity.ai',access:'Live web · threads · agentic verify',coverage:'Live URLs · model licensing · DNS · SSL',status:'bundle_ready',output:'reports/CH4-perplexity-{date}.md',conflicts:0,note:'CH-4 BUNDLE_READY (23 P-dossiers + appendices)'},
  {id:'CH-5',name:'ChatGPT',surface:'chatgpt.com',access:'Memory + Projects',coverage:'Drafting · Python tooling · custom GPTs · AMARA stopgap',status:'queued',output:'reports/CH5-chatgpt-{date}.md',conflicts:0},
